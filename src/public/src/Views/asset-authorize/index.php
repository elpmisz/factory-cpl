      ...
      <div class="card-body">
        ...
        <div class="row justify-content-end mb-2">
          <div class="col-xl-3 mb-2">
            <a href="/asset/authorize/excel" class="btn btn-sm btn-success btn-block">
              <i class="fa fa-download pr-2"></i>นำข้อมูลออก
            </a>
          </div>
          <div class="col-xl-3 mb-2">
            <a href="/asset/authorize/create" class="btn btn-sm btn-primary btn-block">
...
<script>
  ...
  $(document).on("click", ".btn-delete", function(e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        axios.post("/asset/authorize/delete", {
          id: id
        }).then((res) => {
