...
$brand = (intval($row['type_id']) === 1 ? "checked" : "");
$model = (intval($row['type_id']) === 2 ? "checked" : "");
    ...
    <div class="card shadow">
      ...
      <div class="card-body">
        ...
        <div class="row justify-content-end mb-2">
          <div class="col-xl-12">
            <form action="/asset/brand/update" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                  ...
                  <div class="row pb-2">
                    <div class="col-xl-3">
                      <label class="form-check-label px-3">
                        <input class="form-check-input" type="radio" name="type" value="1" <?php echo $brand ?> required>
                        <span class="text-success">ยี่ห้อ</span>
                      </label>
                    </div>
                    <div class="col-xl-3">
                      <label class="form-check-label px-3">
                        <input class="form-check-input" type="radio" name="type" value="2" <?php echo $model ?> required>
              ...
              <div class="row mb-2 reference-div">
                ...
                <div class="col-xl-4">
                  <select class="form-control form-control-sm brand-select" name="reference">
                    <?php
